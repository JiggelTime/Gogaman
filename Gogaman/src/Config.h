...
#define FULL_RESOLUTION      1.0f
#define QUARTER_RESOLUTION   0.5f
#define EIGHTH_RESOLUTION    0.25f
#define SIXTEENTH_RESOLUTION 0.125f
...
public:
	...
	//Bloom
		...
		const float bloomResScale   = EIGHTH_RESOLUTION;
